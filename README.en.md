...
- Filter replies on status pages by following count, follower count, default avatar, or verification status
...
- No analytics
- Post content and public account data are processed only in the current tab and are not stored or uploaded
